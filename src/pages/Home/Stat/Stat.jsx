...
const stats = [
    { id: 1, name: 'Years of Experience', value: '1+', icon: <FaCalendarAlt className="text-blue-500 text-4xl" /> },
    ...
    { id: 4, name: 'Team Members', value: '3', icon: <FaUsers className="text-red-500 text-4xl" /> }
];
