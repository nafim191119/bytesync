...
const stats = [
    ...
    { id: 2, name: 'Happy Clients', value: '7', icon: <FaSmile className="text-yellow-500 text-4xl" /> },
    { id: 3, name: 'Projects Finished', value: '10+', icon: <FaTasks className="text-green-500 text-4xl" /> },
    { id: 4, name: 'Team Members', value: '18+', icon: <FaUsers className="text-red-500 text-4xl" /> }
];
